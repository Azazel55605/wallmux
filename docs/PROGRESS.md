...
- 2026-06-08: Changed close-after-set GUI behavior to close immediately after submitting the request while the switch completes in a detached worker thread.
